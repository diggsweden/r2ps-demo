...
public class BeanConfiguration {
  ...
  @Bean
  DefaultServiceRequestHandler opaqueServiceRequestHandler(OpaqueServiceRequestHandlerConfiguration requestHandlerConfiguration)
  ...
  List<ServiceTypeHandler> serviceTypeHandlerList(SessionServiceHandler sessionServiceHandler,
      ...
      SessionTaskRegistry sessionTaskRegistry, ClientRecordRegistry clientRecordRegistry, GenericHSMServiceHandler hsmServiceHandler) {
